...
import { getPlan, listOrders } from "../../api/lib/data-store";
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 max-w-md text-[15px] text-[#6B6558]">
          Every box generated by your subscription, from checkout through to your
          door.
        </p>
      </div>
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        ...
        <StatCard
          ...
          value={
            nextUpcoming
              ? new Date(nextUpcoming.deliveryDate).toLocaleDateString("en-NG", {
                  month: "short",
                  day: "numeric",
                })
              : "All caught up"
