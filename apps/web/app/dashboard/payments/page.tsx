...
export default async function PaymentsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <p className="text-xs uppercase tracking-[0.26em] text-[#BC8A31]">Payments</p>
        <h1 className="mt-2 font-display text-3xl text-[#17251C]">Payment history</h1>
      </div>
      ...
      <div className="rounded-3xl border border-[#E4DCC8] bg-white p-6">
        {payments.length === 0 ? (
          <div className="flex flex-col items-center gap-2 rounded-2xl border border-dashed border-[#E4DCC8] py-14 text-center">
            <p className="text-sm font-medium text-[#17251C]">No payments yet</p>
            ...
            {payments.map((payment) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-[#17251C]">₦{payment.amount.toLocaleString()}</span>
